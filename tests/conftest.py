...
def sample_orders_data() -> list[tuple]:
    ...
    return [
        ("ORD-001", "CUST-A", "PROD-X", 2, Decimal("19.99"), "DELIVERED",
         datetime.date(2024, 1, 15), "ONLINE"),
        ("ORD-002", "CUST-B", "PROD-Y", 1, Decimal("99.50"), "SHIPPED",
         datetime.date(2024, 1, 16), "MOBILE"),
        ("ORD-003", "CUST-C", "PROD-Z", 3, Decimal("5.00"),  "PENDING",
         datetime.date(2024, 1, 17), "STORE"),
    ]
